...
public class FolderUtil {
    ...
    public static void readPackageValue() {
        ...
        System.err.println("global config setting -->" + PropertiesKey.MODEL_PACKAGE + " | " + Contants.DEFAULT_MODEL);
        System.err.println("global config setting -->" + PropertiesKey.DAO_PACKAGE + " | " + Contants.DEFAULT_DAO);
        System.err.println("global config setting -->" + PropertiesKey.SERVICE_PACKAGE + " | " + Contants.DEFAULT_SERVICE);
        System.err.println("global config setting -->" + PropertiesKey.SERVICE_IMPL_PACKAGE + " | " + Contants.DEFAULT_SERVICE_IMPL);
        System.err.println("global config setting -->" + PropertiesKey.CONTROLLER_PACKAGE + " | " + Contants.DEFAULT_CONTROLLER);
        System.err.println("global config setting -->" + PropertiesKey.XML_PATH + " | " + Contants.DEFAULT_XML);
    }
