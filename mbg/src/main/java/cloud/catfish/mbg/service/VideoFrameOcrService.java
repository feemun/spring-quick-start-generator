...
public interface VideoFrameOcrService {
     ...
     */
    PageResult<VideoFrameOcrVO> page(VideoFrameOcrReq req);
     ...
     * @return VO查询结果
     */
    VideoFrameOcrVO selectByPrimaryKey(Long id);
     ...
     * @return 是否更新成功
     */
    Boolean updateByPrimaryKeySelective(VideoFrameOcr record);
     ...
     * @return 影响行数
     */
    int updateByExampleSelective(VideoFrameOcr updateData, VideoFrameOcrReq condition);
     ...
     * @return 影响行数
     */
    int deleteByExample(VideoFrameOcrReq condition);
     ...
     * @return 是否新增成功
     */
    Boolean insertSelective(VideoFrameOcr record);
     ...
     * @return 是否新增成功
     */
    Boolean batchInsert(List<VideoFrameOcr> records);
