...
public interface VideoFrameService {
     ...
     */
    PageResult<VideoFrameVO> page(VideoFrameReq req);
     ...
     * @return VO查询结果
     */
    VideoFrameVO selectByPrimaryKey(Long id);
     ...
     * @return 是否更新成功
     */
    Boolean updateByPrimaryKeySelective(VideoFrame record);
     ...
     * @return 影响行数
     */
    int updateByExampleSelective(VideoFrame updateData, VideoFrameReq condition);
     ...
     * @return 影响行数
     */
    int deleteByExample(VideoFrameReq condition);
     ...
     * @return 是否新增成功
     */
    Boolean insertSelective(VideoFrame record);
     ...
     * @return 是否新增成功
     */
    Boolean batchInsert(List<VideoFrame> records);
