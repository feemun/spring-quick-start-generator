...
public interface VideoFrameFaceService {
     ...
     */
    PageResult<VideoFrameFaceVO> page(VideoFrameFaceReq req);
     ...
     * @return VO查询结果
     */
    VideoFrameFaceVO selectByPrimaryKey(Long id);
     ...
     * @return 是否更新成功
     */
    Boolean updateByPrimaryKeySelective(VideoFrameFace record);
     ...
     * @return 影响行数
     */
    int updateByExampleSelective(VideoFrameFace updateData, VideoFrameFaceReq condition);
     ...
     * @return 影响行数
     */
    int deleteByExample(VideoFrameFaceReq condition);
     ...
     * @return 是否新增成功
     */
    Boolean insertSelective(VideoFrameFace record);
     ...
     * @return 是否新增成功
     */
    Boolean batchInsert(List<VideoFrameFace> records);
