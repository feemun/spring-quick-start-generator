 ...
 * 
 * <p>This plugin automatically generates RequestParam classes with:</p>
 * <ul>
 *   <li>Bean Validation annotations for parameter validation</li>
 *   <li>Swagger3 annotations for API documentation</li>
 *   <li>Date range query support for LocalDateTime fields</li>
 *   <li>Inheritance from BaseRequestParam for pagination and sorting</li>
 * </ul>
 * 
...
public class RequestParamGeneratorPlugin extends PluginAdapter {
    ...
    private void generateRequestParamClass(TopLevelClass domainClass, IntrospectedTable introspectedTable) throws IOException {
        ...
        content.append("public class ").append(requestParamClassName).append(" extends BaseRequestParam {\n\n");
        ...
        // Note: Pagination and sorting fields are now inherited from BaseRequestParam
