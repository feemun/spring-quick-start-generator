...
//
//import cloud.catfish.mbg.comm.Common;
...
//    private static final String DEFAULT_BASE_PACKAGE_PATH = "mbg/src/main/java/" + Common.SERVICE_PACKAGE_RELATIVE_NAME;
//    private static final String MODEL_PACKAGE_SUFFIX = ".model";
//    private static final String SERVICE_PACKAGE_SUFFIX = Common.SERVICE_PACKAGE_NAME.substring(Common.ROOT_PACKAGE.length());
//
//    // Naming Convention Constants
//    private static final String SERVICE_CLASS_PREFIX = "I";
//    private static final String SERVICE_CLASS_SUFFIX = Common.SERVICE_FILE_NAME;
//    private static final String REQUEST_PARAM_CLASS_SUFFIX = "RequestParam";
//    private static final String VO_CLASS_SUFFIX = "Vo";
//    private static final String VO_PACKAGE_SUFFIX = Common.VO_PACKAGE_NAME.substring(Common.ROOT_PACKAGE.length());
