...
import cloud.catfish.api.converter.VideoFrameOcrConverter;
...
public class VideoFrameOcrServiceImpl implements VideoFrameOcrService {
   ...
   public String importExcel(MultipartFile file) throws Exception {
       try {
           ...
           // List<cloud.catfish.api.domain.VideoFrameOcr> records = parseExcelFile(file);
           ...
           // for (cloud.catfish.api.domain.VideoFrameOcr record : records) {
   ...
   // private List<cloud.catfish.api.domain.VideoFrameOcr> parseExcelFile(MultipartFile file) throws Exception {
